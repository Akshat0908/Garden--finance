...
function transformModule(code, ast, moduleName, bundleInfo, options) {
    ...
    const exportedNamesDeclaration = (0, make_node_1.makeVariablesDeclaration)(exportedNames.filter(name => !importedNames.has(name)));
    ...
    for (const importDeclaration of imports) {
        const importedModuleName = (0, resolve_import_1.resolveImport)(moduleName, importDeclaration.source.value);
        if (!importedModuleName || !bundleInfo[importedModuleName])
            continue;
        if (bundleInfo[importedModuleName].transformNeeded) {
            importDeclaration.specifiers.push((0, make_node_1.makeImportSpecifier)(options.promiseExportName, options.promiseImportName(importedPromiseCount)));
     ...
     * export { ..., __tla };
     */
    const newTopLevel = [...imports, exportedNamesDeclaration];
